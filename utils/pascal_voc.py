...
class pascal_voc(object):
    def __init__(self, phase, rebuild=False):
        ...
        self.devkil_path = os.path.join(cfg.PASCAL_PATH, 'voc20171211')
        self.data_path = os.path.join(self.devkil_path, 'VOC2007')
    ...
    def get(self):
        ...
        ############################################################################
        # labels = np.zeros((self.batch_size, self.cell_size, self.cell_size, 6))#201712051750
        ##########################################################################
        count = 0
    ...
    def load_labels(self):
        cache_file = os.path.join(self.cache_path, 'pasca_' + self.phase + '_gt_labels.pkl')
    ...
    def load_pascal_annotation(self, index):
        ...
        # label = np.zeros((self.cell_size, self.cell_size, 6))#201712051749
